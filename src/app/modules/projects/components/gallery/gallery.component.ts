...
export class GalleryComponent implements OnInit {
  projects: any = [
    ...
    { id: 3, name: 'Weatherspot', subtext: 'javascript application', img: 'https://images.unsplash.com/photo-1516912481808-3406841bd33c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1883&q=80', link: '', alt: 'photo' },
